...
export class TCGBattleFieldView implements Component {
    private static instance: TCGBattleFieldView | null = null;

    private scene: THREE.Scene;
    private camera: THREE.OrthographicCamera;
    private renderer: THREE.WebGLRenderer;
    private textureManager: TextureManager;
    private battleFieldContainer: HTMLElement;
    ...
    constructor(battleFieldContainer: HTMLElement, routeMap: RouteMap) {
        this.battleFieldContainer = battleFieldContainer;
        this.scene = new THREE.Scene();
        this.scene.background = new THREE.Color(0xffffff);
        this.renderer = new THREE.WebGLRenderer();
        this.renderer.setSize(window.innerWidth, window.innerHeight);
        this.battleFieldContainer.appendChild(this.renderer.domElement);
    ...
    public static getInstance(lobbyContainer: HTMLElement, routeMap: RouteMap): TCGBattleFieldView {
        if (!TCGBattleFieldView.instance) {
            TCGBattleFieldView.instance = new TCGBattleFieldView(lobbyContainer, routeMap);
        }
        return TCGBattleFieldView.instance;
    }
    ...
    public show(): void {
        ...
        this.battleFieldContainer.style.display = 'block';
        this.isAnimating = true;
        if (!this.initialized) {
