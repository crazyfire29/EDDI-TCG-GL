export class BattleFieldHandMapRepository {
    private static instance: BattleFieldHandMapRepository;
    ...
    public static getInstance(): BattleFieldHandMapRepository {
        if (!BattleFieldHandMapRepository.instance) {
            BattleFieldHandMapRepository.instance = new BattleFieldHandMapRepository();
        }
        return BattleFieldHandMapRepository.instance;
    }
