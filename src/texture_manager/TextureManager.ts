...
export class TextureManager {
    ...
    private deckCardPageMovementButtonTextureList : { [id: number]: THREE.Texture } = {};
    ...
    public async preloadTextures(jsonUrl: string): Promise<void> {
        ...
        try {
            ...
            await Promise.all([
                ...
                this.loadTextures(imageData.deck_card_page_movement_buttons, this.deckCardPageMovementButtonTextureList),
    ...
    public async getTexture(category: string, id: number): Promise<THREE.Texture | undefined> {
        ...
        switch (category) {
            ...
            case 'deck_card_page_movement_buttons':
                return this.deckCardPageMovementButtonTextureList[id]
            case 'card_kinds':
